 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://com/", wsdlLocation = "http://192.168.0.145:1000/MyWebService/calculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.0.145:1000/MyWebService/calculator?wsdl");
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/", "CalculatorPort"), Calculator.class, features);
    }
